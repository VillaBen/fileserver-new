module.exports = {
  ...
  fileSignatures: {
    ...
    'flac': ['664c6143'],  // FLAC
    'aac': ['fff1', 'fff9'],  // AAC
    'm4a': ['0000001866747970', '4d344120'],  // M4A
    'wma': ['3026b2758e66cf11'],
    
    // 视频文件
    'mp4': ['0000001866747970', '0000001c66747970', '0000002066747970', '0000002466747970'],  // 支持不同大小的 ftyp 框
    '3gp': ['0000001466747970', '0000001c66747970'],  // 3GPP 格式
    '3g2': ['0000001c6674797033673270'],  // 3GPP2 格式
    'webm': ['1a45dfa3'],
    'mov': ['0000001866747970', '667479704d534e56', '0000002066747970'],  // MOV/QuickTime
    'avi': ['52494646'],  // RIFF头
    'mkv': ['1a45dfa3'],  // MKV与WebM相同
    'flv': ['464c5601']   // FLV
  },
